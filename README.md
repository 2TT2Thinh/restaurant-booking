...
| Method | Endpoint | Description |
|--------|----------|-------------|
| GET | `/api/v1/suggestions/slot` | Check slot availability |
| GET | `/api/v1/suggestions/times` | Suggest alternative times |
| GET | `/api/v1/suggestions/dates` | Suggest alternative dates |
| GET | `/api/v1/suggestions/heatmap/{id}` | Restaurant peak hours |
